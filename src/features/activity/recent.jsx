...
const RecentAttendance = ({
  ...
  return (
    <div className="bg-white h-[32rem] overflow-y-auto dark:bg-base-100 rounded-md shadow-md text-gray-800 dark:text-dark-text p-4 border dark:border-[#2B3039] dark:border-[2px]">
